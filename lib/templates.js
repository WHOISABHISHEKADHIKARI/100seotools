...
export function getTemplateDefinition(key) {
  ...
  const defs = {
    ...
    sitemapGenerator: {
      ...
      fields: [
        { name: 'url', label: 'Website URL', type: 'url', placeholder: 'https://example.com', example: baseUrl }
      ]
    },
    brokenLinkFinder: {
    ...
    rankingProgressTracker: {
      ...
      fields: [
        { name: 'keywords', label: 'Keywords & Ranks (one per line)', type: 'textarea', placeholder: 'keyword1,#12,#15\nkeyword2,#8,#10\nkeyword3,#4,#1', hint: 'Format: keyword,current_rank,previous_rank (one per line). Or use single-mode fields below.', example: 'seo tools,#12,#15\nkeyword research,#8,#10\ncontent marketing,#4,#1' },
        { name: 'current_rank', label: 'Current Rank (single mode)', type: 'number', placeholder: '12', example: '8' },
        { name: 'previous_rank', label: 'Previous Rank (single mode)', type: 'number', placeholder: '15', example: '14' }
      ]
    },
    readabilityEnhancer: {
    ...
    contentGapFinder: {
      actionLabel: 'Find Content Gaps',
      fields: [
        { name: 'my_content', label: 'My Content', type: 'textarea', placeholder: 'Paste your content...', example: 'Our agency provides SEO and content strategy for local businesses. We focus on ROI and transparency.', required: true },
        { name: 'competitor_content', label: 'Competitor Content', type: 'textarea', placeholder: 'Paste competitor content...', example: 'We are a full-service digital marketing agency offering PPC, SEO, and social media management for global brands.', required: true }
      ]
    },
    ctrPredictor: {
    ...
    featuredToolSchemaGenerator: {
      ...
      fields: [
        ...
        { name: 'pageUrl', label: 'Page URL', type: 'url', placeholder: `${baseUrl}/tool-name`, example: `${baseUrl}/tools/schema-generator` },
        { name: 'brandLogo', label: 'Brand Logo URL', type: 'url', placeholder: `${baseUrl}/logo.png`, example: `${baseUrl}/logo-dark.png` },
        ...
        { name: 'breadcrumbItems', label: 'Breadcrumb Items (JSON Array)', type: 'textarea', placeholder: '[{"@type": "ListItem", "position": 1, "name": "Home", "item": "..."}]', example: `[{"@type": "ListItem", "position": 1, "name": "Home", "item": "${baseUrl}"}]` }
      ]
    },
  };
