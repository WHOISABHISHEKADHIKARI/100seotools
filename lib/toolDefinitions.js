...
export function getTemplateDefinition(key) {
  const defs = {
    ...
    featuredToolSchemaGenerator: {
      actionLabel: 'Generate Schema',
      fields: [
        { name: 'toolName', label: 'Tool Name', type: 'text', placeholder: 'e.g. Backlink Analyzer' },
        { name: 'pageTitle', label: 'Page Title', type: 'text', placeholder: 'e.g. Free Backlink Analyzer Tool' },
        { name: 'metaDescription', label: 'Meta Description', type: 'textarea', placeholder: 'e.g. Analyze your backlinks...' },
        { name: 'pageUrl', label: 'Page URL', type: 'url', placeholder: 'https://www.100seotools.com/tool-name' },
        { name: 'brandLogo', label: 'Brand Logo URL', type: 'url', placeholder: 'https://www.100seotools.com/logo.png' },
