export function getBaseUrl() {
  ...
  const siteDomain = '100seotools.com';
  const normalizeHttps = (u) => {
    ...
    try {
      ...
      if (host.endsWith(siteDomain) && !host.startsWith('www.')) {
        url.protocol = 'https:';
        url.host = preferHost;
      }
      return url.origin;
...
export const socialPreviewImage = '/og-image.jpg';
export const twitterHandle = '@100seotools';
