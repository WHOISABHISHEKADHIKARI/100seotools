...
export function getToolGuide(tool) {
  ...
  // Tool-specific content fields (when defined on the tool object)
  // These override or extend category-level defaults for richer, unique content per tool.
  ...
  const fieldSteps = (def.fields || []).map((f) => {
    ...
    const example = placeholder ? (placeholder.toLowerCase().startsWith('e.g.') ? ` ${placeholder}` : ` e.g., ${placeholder}`) : '';
  ...
  const categoryBenefits = {
    ...
    'Schema & Structured Data': [
      'Generate valid JSON-LD for rich result eligibility',
      'Improve search visibility with specific entity markup',
      'Standardize tool and software information for crawlers',
      'Increase click-through rates with enhanced SERP features',
    ]
  };
  ...
  const categoryUseCases = {
    ...
    'Schema & Structured Data': [
      'Win rich snippets for online tools and software',
      'Clarify software features and pricing for search engines',
      'Improve indexing of specialized tool pages',
      'Support software discovery in search results'
    ]
  };

  const benefits = toolContent.benefits || categoryBenefits[tool.category] || [
  ...
  const useCases = toolContent.useCases || categoryUseCases[tool.category] || [
  ...
  const categoryIntros = {
    'Keyword Research': `Identifying the right search terms is the foundation of any successful SEO strategy. ${tool.name} streamlines this process by helping you uncover high-value keywords that align with user intent and business goals. Whether you are building a new content calendar or optimizing existing pages, this tool provides the data-driven insights needed to capture more search traffic and outrank competitors in your niche.`,
    'On-Page Optimization': `${tool.name} is a specialized utility for fine-tuning your on-page elements. In the competitive landscape of 2026, small details like heading structure, meta tag relevance, and keyword placement can make the difference between page one and page ten. Use this tool to ensure every element of your page is perfectly calibrated for both search engine crawlers and human readers, maximizing your visibility and click-through rates.`,
    'Technical SEO': `Technical foundations are the backbone of search visibility. ${tool.name} helps you audit and optimize the underlying structure of your website, from robots.txt and sitemaps to status codes and redirects. By resolving technical friction points, you ensure that search engines can crawl, index, and understand your content without issues, leading to more stable rankings and better overall site health.`,
    'Backlink & Link-Building': `Authority and trust are primary ranking signals, and ${tool.name} is designed to help you grow your site's link profile ethically and effectively. Use this tool to identify high-quality link opportunities, analyze anchor text distribution, and plan your outreach campaigns. By focusing on relevance and authority, you can build a sustainable backlink profile that drives long-term organic growth.`,
    'Content SEO': `Content is king, but only if it's optimized for search. ${tool.name} provides actionable insights to improve your content's relevance, readability, and engagement. From title generation to semantic keyword optimization, this tool helps you create content that resonates with your audience while meeting the latest search engine requirements for E-E-A-T (Experience, Expertise, Authoritativeness, and Trustworthiness).`,
    'SEO Performance': `Data-driven decisions are the key to scaling SEO success. ${tool.name} offers powerful calculators and forecasting utilities to help you estimate ROI, predict traffic potential, and track your ranking progress. By quantifying the impact of your SEO efforts, you can prioritize the tasks that will deliver the greatest return for your business or clients.`,
    'Local SEO': `For businesses serving specific geographic areas, local search visibility is critical. ${tool.name} helps you optimize your presence for local intent, map packs, and localized search results. From NAP consistency checks to local schema generation, this tool ensures your business is easily discoverable by customers in your immediate vicinity.`,
    'Competitor Analysis': `Understanding your competitive landscape is essential for finding growth opportunities. ${tool.name} allows you to benchmark your performance against market leaders, identifying gaps in keywords, content, and backlinks. By analyzing what works for others, you can refine your own strategy and capitalize on ranking opportunities that your competitors have missed.`,
    'AI-Powered SEO': `Leverage the power of artificial intelligence to accelerate your SEO workflow. ${tool.name} combines advanced AI models with SEO best practices to generate high-quality outlines, meta tags, and content improvements in seconds. This tool acts as a force multiplier for your team, allowing you to scale your SEO efforts without sacrificing quality or brand voice.`,
    'SEO Utility': `${tool.name} is a fast, lightweight utility designed to solve specific, everyday SEO tasks with zero friction. Whether you need to generate a clean URL slug, count meta tag lengths, or convert text formats, this tool provides a simple, browser-based solution that keeps your workflow moving without the need for complex software or logins.`,
    'Schema & Structured Data': `Structured data is the bridge between your content and how search engines visualize it. ${tool.name} helps you generate and validate the complex JSON-LD required to win rich snippets and enhanced search features. By providing clear, machine-readable information about your tools and software, you improve your site's eligibility for advanced SERP displays, leading to higher trust and better engagement.`
  };

  const categoryWhatItDoes = {
    'Keyword Research': `This tool analyzes your seed keywords and inputs to generate a structured list of suggestions, modifiers, or intent mappings. It uses advanced tokenization and matching logic to ensure that every result is relevant to your target audience. The output is formatted for immediate use in content briefs, PPC campaigns, or keyword tracking software.`,
    'On-Page Optimization': `By processing your page elements against current SEO standards, this tool identifies optimization opportunities and potential issues. It provides structured feedback on length, relevance, and formatting, helping you create meta tags and headings that stand out in the SERPs while adhering to character limits and best practices.`,
    'Technical SEO': `This utility performs rapid checks on technical configurations, validating syntax and logic for critical site files and tags. It translates complex technical requirements into easy-to-understand reports and generators, allowing you to implement technical fixes like redirects, canonicals, and schema markup with confidence.`,
    'Backlink & Link-Building': `This tool helps you categorize and evaluate link opportunities based on relevance and potential impact. It generates templates and reports that streamline the outreach process, helping you maintain a high standard of quality in your link-building efforts while saving hours of manual data entry.`,
    'Content SEO': `Focusing on the intersection of user experience and search optimization, this tool analyzes your text to improve readability and keyword alignment. It provides suggestions for headings, structure, and semantic depth, ensuring your content is both engaging for readers and highly discoverable for search engines.`,
    'SEO Performance': `Using proven SEO formulas and data models, this tool calculates key performance metrics like CTR, ROI, and traffic potential. It allows you to run simulations and forecasts based on various scenarios, giving you a clear, data-backed view of your SEO performance and future opportunities.`,
    'Local SEO': `This tool focuses on the specific signals that drive local rankings, such as geographic modifiers, business data consistency, and local schema. It provides checklists and generators that help you align your site with the requirements of local search and Google Business Profile optimization.`,
    'Competitor Analysis': `This utility compares your site's data against competitors to surface overlap and gaps. It visualizes the competitive landscape, highlighting where you are winning and where there are opportunities to gain ground through better keyword targeting or content depth.`,
    'AI-Powered SEO': `Using specialized prompts and SEO-tuned AI models, this tool generates creative and technical outputs that would otherwise take hours of manual work. It handles everything from FAQ generation to article outlining, providing a high-quality starting point that you can refine to match your specific needs.`,
    'SEO Utility': `This tool performs a single, focused task with high efficiency, such as formatting text, generating tags, or calculating lengths. It's designed for speed and simplicity, giving you the exact output you need for your CMS, HTML, or documentation without any unnecessary steps.`,
    'Schema & Structured Data': `This generator processes tool-specific information into valid Schema.org JSON-LD. It covers critical properties like application category, operating system, and pricing, ensuring that search engines have a complete and accurate understanding of your software's capabilities and value.`
  };

  const categoryWhyItMatters = {
    'Keyword Research': `Targeting the wrong keywords can waste months of effort. By using ${tool.name}, you ensure that your content is built on a foundation of high-intent, relevant terms that your audience is actually searching for. This leads to higher quality traffic, better conversion rates, and a more sustainable SEO strategy.`,
    'On-Page Optimization': `Search engines use on-page elements to understand the context and relevance of your content. Well-optimized tags and headings not only help with rankings but also significantly improve your click-through rate (CTR) by making your search results more appealing to users.`,
    'Technical SEO': `Even the best content can't rank if it can't be indexed. Technical SEO ensures that there are no barriers between your content and the search engine crawlers. A technically sound site is faster, more reliable, and much easier for search engines to prioritize in their rankings.`,
    'Backlink & Link-Building': `Backlinks remain one of the most powerful ranking signals. However, quality matters more than quantity. This tool helps you focus on building a natural, authoritative link profile that search engines trust, protecting your site from penalties while driving significant authority growth.`,
    'Content SEO': `As search algorithms become more sophisticated, they prioritize content that provides genuine value and a good user experience. This tool helps you bridge the gap between "writing for SEO" and "writing for humans," ensuring that your content satisfies both the algorithms and your readers.`,
    'SEO Performance': `Without measurement, there is no improvement. Understanding your SEO performance through data allows you to move beyond guesswork and make strategic decisions that grow your business. These insights help you justify SEO spend and focus your resources where they will have the most impact.`,
    'Local SEO': `Local search is often the highest-converting traffic source for brick-and-mortar businesses. Optimizing for local SEO ensures you appear in the "Near Me" searches that drive foot traffic and local phone calls, giving you a competitive edge in your local market.`,
    'Competitor Analysis': `SEO is a zero-sum game; for you to move up, someone else must move down. Competitor analysis gives you the roadmap to outperforming your rivals by showing you exactly what is working for them and where they are vulnerable.`,
    'AI-Powered SEO': `The speed of content creation is increasing, and AI is a critical tool for staying competitive. Using AI-powered tools allows you to maintain a high volume of optimized content and metadata, giving you more time to focus on high-level strategy and creative tasks.`,
    'SEO Utility': `Small tasks can eat up a lot of time over the course of a week. These utilities reduce friction in your daily SEO workflow, allowing you to perform checks and generate tags in seconds so you can stay focused on the bigger picture of your SEO strategy.`,
    'Schema & Structured Data': `Rich snippets are proven to increase CTR by making search results more prominent and informative. Implementing structured data correctly protects your site from technical errors while maximizing your presence in specialized search features, giving your tools the visibility they deserve.`
  };

  const hero = {
    h1: `${tool.name} | 100 SEO Tools`,
    subheadline: `Professional-grade ${tool.category.toLowerCase()} utility for SEO experts and content creators.`,
    oneLiner: purpose.length > 20 ? purpose : `Use the ${tool.name} to optimize your ${tool.category.toLowerCase()} workflow and boost your search rankings.`,
    ctaText: def.actionLabel || 'Generate'
  };

  const categorySpecificBenefits = {
    'Keyword Research': 'uncover search opportunities',
    'On-Page Optimization': 'fine-tune your content',
    'Technical SEO': 'strengthen your site foundation',
    'Backlink & Link-Building': 'grow your authority',
    'Content SEO': 'create better content',
    'SEO Performance': 'track your success',
    'Local SEO': 'win local search',
    'Competitor Analysis': 'outsmart your rivals',
    'AI-Powered SEO': 'scale your efforts',
    'SEO Utility': 'speed up your workflow',
    'Schema & Structured Data': 'win rich snippets'
  };

  const specificBenefit = categorySpecificBenefits[tool.category] || 'improve your SEO results';

  let introduction = toolContent.introduction || categoryIntros[tool.category] || `${tool.name} is a free ${tool.category.toLowerCase()} tool designed to help you ${specificBenefit.toLowerCase()}. It runs entirely in your browser with no login and keeps your workflow simple: enter inputs, click ${def.actionLabel || 'Run'}, and reuse the results immediately. If you’re drafting, validating, or improving content and metadata, this tool helps you get consistent, SEO‑friendly results with minimal effort.`;

  let whatItDoes = toolContent.whatItDoes || categoryWhatItDoes[tool.category] || `This tool processes your inputs using a structured template for ${tool.name.toLowerCase()}. It formats outputs for quick review and reuse, and it emphasizes clarity, relevance, and basic SEO guardrails. Typical results include concise text blocks, lists, or JSON snippets that are ready for copying to your CMS or codebase.`;

  let whyItMattersSEO = toolContent.whyItMatters || categoryWhyItMatters[tool.category] || `Clear, structured outputs improve crawlability and user engagement. By aligning titles, descriptions, headings, and copy with keywords and intent, you set content up for better indexing and richer snippets. Lightweight client‑side tools also reduce friction for everyday checks, keeping your SEO process responsive and consistent.`;

  let howToSteps = toolContent.howToSteps || (def.fields || []).map((f, i) => ({
    step: `Step ${i + 1}: Enter ${f.label.toLowerCase()}`,
    tip: `Pro tip: Use specific, audience‑aware phrasing${f.placeholder ? ` (${f.placeholder.toLowerCase().startsWith('e.g.') ? f.placeholder : `e.g., ${f.placeholder}`})` : ''}.`
  })).concat([
    {
  ...
  let exampleResults = toolContent.exampleResults || `Example outputs are concise and structured for immediate use. Expect clean lines, readable lists, or small blocks of text that you can drop into drafts, metadata, or documentation. Adjust tone and specificity to match your audience.\n\nSample JSON:\n{\n  \"tool\": \"${tool.slug}\",\n  \"inputs\": ${JSON.stringify((def.fields || []).reduce((acc, f) => { acc[f.name] = f.placeholder || ''; return acc; }, {}))},\n  \"outputHint\": \"Copy/paste into CMS, HTML tags, or docs\"\n}`;

  let bestPractices = toolContent.bestPractices || [
  ...
  let qualityAccessibility = toolContent.qualityAccessibility || [
  ...
  const relatedTools = [...new Set([...(toolContent.relatedTools || []), ...defaultRelatedTools])].slice(0, 10);

  // Minimal FAQs – tool-specific overrides, then category defaults
  // Questions optimized for "People also ask" (PAA) voice-search and featured snippet formats
  const defaultFaqs = [
    { q: `How do I use the ${tool.name} tool for SEO?`, a: howToUse.replace(/\n/g, ' ') },
    { q: `Is the ${tool.name} completely free to use?`, a: 'Yes, it is 100% free with no signup, no limits, and no hidden costs. All processing happens locally in your browser.' },
    { q: 'Does this tool work on mobile devices and tablets?', a: 'Yes. The interface is fully responsive and supports touch, keyboard, and screen reader input on all screen sizes.' },
    { q: `What makes ${tool.name} different from other ${tool.category.toLowerCase()} tools?`, a: `It is fast, privacy-first (client-side only), and focused on clear, reusable outputs with built-in SEO guardrails. No login, no data storage, and no server processing.` },
    { q: `How accurate are the results from ${tool.name}?`, a: 'Results are based directly on your inputs and the underlying processing logic. Review outputs for brand voice relevance and adjust as needed.' },
    { q: `Can I customize the output tone and format?`, a: 'Yes. Provide specific context in the input fields and refine the generated output to match your brand voice and audience.' },
    { q: `Is my data safe and private when using ${tool.name}?`, a: 'Yes. All processing is done client-side in your browser — we do not store, transmit, or share your inputs or results.' },
    { q: 'Can I copy or download the results for later use?', a: 'Yes. Use the Copy button to paste results into your CMS, or the Download button to save them as a file.' },
    { q: `How often should I use ${tool.name} for best results?`, a: 'Use it as part of your regular SEO workflow — whenever you create or update content, audit pages, or need quick optimization checks.' },
    { q: `What are the main benefits of using ${tool.name}?`, a: 'Fast client-side processing, no login required, privacy-first design, consistent outputs, and actionable guidance aligned with current SEO best practices.' }
  ];
  const faqs = toolContent.faqs && toolContent.faqs.length > 0
    ? [...toolContent.faqs, ...defaultFaqs.filter(df => !toolContent.faqs.some(tf => tf.q === df.q))]
    : [...defaultFaqs];
  ...
  if (tool.slug === 'keyword-gap-finder') {
    faqs.unshift(
      { q: 'How is the gap score calculated?', a: 'The gap score combines keyword volume, the number of competitors ranking, and the average ranking position of competitors. Higher scores mean more competitors rank higher for that keyword, indicating stronger demand and more urgent opportunity.' },
      { q: 'Should I target gaps where only one competitor ranks?', a: 'Only if that competitor is directly relevant to your audience. Single-competitor gaps may indicate a niche keyword with low demand rather than an untapped opportunity. Cross-reference with search volume before investing content resources.' },
      { q: 'How do I prioritize gap keywords by business impact?', a: 'Sort by strategic alignment first (does the keyword match your product or service?), then by opportunity score (volume × competitor count), then by content investment needed. High-alignment, high-opportunity, low-investment gaps are quick wins you can capture in 2-4 weeks.' },
      { q: 'What content types work best for gap keywords?', a: 'Match the format competitors used successfully. If all competitors rank with blog posts, write a more comprehensive post. If they rank with product pages, create a comparison or category page. If they use video, create a complementary written guide with embedded video.' }
    );
    bestPractices.push('Run gap analysis monthly — new competitor content creates new gaps that are easiest to exploit in the first 90 days');
    bestPractices.push('Filter gaps by difficulty: target difficulty ≤ 40 keywords first for fastest ranking gains');
    bestPractices.push('Create content clusters around gap keywords: one pillar page per 3-5 related gap keywords');
    bestPractices.push('Track gap closure: re-run analysis monthly to see which gaps you closed and which new ones emerged');
    qualityAccessibility.push('Use clear, data-driven tables for gap comparison outputs');
    relatedTools.unshift('keyword-difficulty-estimator', 'competitor-keyword-overlap-checker', 'keyword-intent-identifier');
    howToSteps.unshift(
      { step: 'Step: Enter your domain', tip: 'Start with your primary domain and add 2-4 direct competitors.' },
      { step: 'Step: Review gap categories', tip: 'Focus on Critical Gaps first (all competitors rank) — these have highest proven demand.' },
      { step: 'Step: Filter by difficulty', tip: 'Set difficulty filter ≤ 40 to find realistic quick-win opportunities.' },
      { step: 'Step: Analyze ranking pages', tip: 'Open competitor ranking pages to understand content depth and format needed.' },
      { step: 'Step: Create content plan', tip: 'Build a content calendar sorted by opportunity score descending.' },
      { step: 'Step: Track and iterate', tip: 'Re-run analysis monthly and adjust strategy based on ranking progress.' }
    );
    exampleResults = `Gap Analysis Sample\n\nYour Site: example.com\nCompetitors: competitor-a.com, competitor-b.com, competitor-c.com\n\nCritical Gaps (All 3 competitors rank):\n1. "keyword gap analysis" — Vol: 3,200 | Diff: 38 | Best rank: #4\n2. "competitor keyword research tool" — Vol: 2,900 | Diff: 32 | Best rank: #6\n3. "seo gap analysis tool free" — Vol: 1,800 | Diff: 28 | Best rank: #3\n\nCommon Gaps (2 of 3 rank):\n1. "content gap analysis seo" — Vol: 2,400 | Diff: 35 | Competitors: A, C\n2. "missing keywords seo" — Vol: 1,200 | Diff: 22 | Competitors: B, C\n\nOpportunity Gaps:\n1. "free competitor keyword finder" — Vol: 1,600 | Diff: 18 | Weaker competitor at #7\n2. "keyword opportunity finder" — Vol: 890 | Diff: 15 | Weaker competitor at #5\n\nTotal gaps: 94 | Quick wins (diff ≤ 35): 31 | Est. traffic potential: 142,000/mo`;
  }

  if (tool.slug === 'gmb-optimization-helper') {
    faqs.unshift(
      { q: 'What is the most impactful GBP optimization I can make today?', a: 'Selecting the most specific primary category. Most businesses choose generic categories like "Restaurant" instead of "Italian Restaurant" or "Pizza Restaurant." Category specificity is the single highest-impact GBP optimization because it directly tells Google what search queries your business should appear for.' },
      { q: 'How many secondary categories should I add to GBP?', a: 'Add all relevant secondary categories — Google allows up to 10. Each category adds potential search queries your business can rank for. A bakery might add "Cake Shop", "Coffee Shop", "Wedding Bakery", "Cookie Shop", and "Dessert Shop" as secondary categories.' },
      { q: 'Does GBP post frequency affect rankings?', a: 'Yes — active profiles rank higher. Post at least once per week. Posts expire after 7 days, so consistent posting keeps your profile fresh. Mix post types: offers, events, updates, and product showcases for maximum engagement signals.' },
      { q: 'How do I optimize GBP for multiple service areas?', a: 'Set your service area radius to cover all locations you serve, then create separate GBP location pages for each physical storefront. For service-area businesses without a storefront, set a broad radius and focus on service-area keywords in your description.' }
    );
    bestPractices.push('Select the most specific primary category — this is the highest-impact GBP optimization');
    bestPractices.push('Write a 750-character description with natural location and service keywords, not keyword stuffing');
    bestPractices.push('Post weekly with high-quality photos — GBP posts with images get 3x more engagement');
    bestPractices.push('Pre-populate Q&A with your top 10 most-asked questions and detailed answers');
    bestPractices.push('Upload geotagged photos of your interior, exterior, products, team, and menu');
    bestPractices.push('Respond to ALL reviews within 24 hours — positive and negative — to demonstrate active management');
    qualityAccessibility.push('Ensure GBP description is readable at Flesch score ≥ 60 for maximum customer comprehension');
    relatedTools.unshift('local-seo-audit-checklist', 'review-response-generator', 'local-keyword-generator', 'local-schema-builder');
    howToSteps.unshift(
      { step: 'Step: Check primary category', tip: 'Verify your primary category is the most specific match for your business.' },
      { step: 'Step: Optimize description', tip: 'Write a keyword-rich description with natural location and service keywords.' },
      { step: 'Step: Add all secondary categories', tip: 'Select up to 10 relevant secondary categories for maximum query coverage.' },
      { step: 'Step: Create posting schedule', tip: 'Plan weekly GBP posts with photos, offers, events, and product showcases.' },
      { step: 'Step: Pre-populate Q&A', tip: 'Add and answer your top 10 most common customer questions.' },
      { step: 'Step: Set up review monitoring', tip: 'Configure alerts for new reviews and respond within 24 hours.' }
    );
    exampleResults = `GBP Optimization Report\n\nBusiness: Austin Pizza Co.\n\nCurrent Score: 52/100\n\nCritical Fixes Needed:\n- Primary category: "Food" → "Pizza Restaurant" (specificity gain: +18 visibility)\n- Missing 5 secondary categories (currently only 2 of 10 used)\n- Description: only 340 chars — expand to 750 with "Austin pizza delivery" and "Italian cuisine" keywords\n- Q&A: empty — add 10 common questions\n- Photos: 4 uploaded — minimum 20 recommended for optimal performance\n\nPosting Schedule:\n- Weekly posts needed (currently posting 1x/month)\n- Mix: offers (weekly specials), events (live music), product showcases (new menu items)\n\nProjected Impact:\n- +22% Local Pack impressions within 45 days\n- +15% direction requests within 60 days\n- +12% website clicks from GBP within 90 days`;
  }
  ...
  const contactSupport = {
    email: `support@${baseUrl.replace(/^https?:\/\/(www\.)?/, '')}`,
...
export function getInstructionEntry(slug) {
  return null;
}
