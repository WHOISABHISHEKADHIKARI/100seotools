...
const aiDetectorGuide = {
  ...
  sections: {
    ...
    how: [
      ...
      { text: 'Rewrite content to sound more human', slug: 'ai-text-humanizer', label: 'AI Text Humanizer' },
      { text: 'Check plagiarism alongside AI', slug: 'plagiarism-checker', label: 'Plagiarism Checker' }
    ],
    possibleUses: [
